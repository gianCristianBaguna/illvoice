...
import { LayoutDashboard, BarChart3, MapPin, Users, Settings, MoreVertical } from 'lucide-react'

export function Sidebar() {
  return (
    <aside className="w-48 bg-slate-950 text-white flex flex-col p-6 fixed left-0 top-0 h-screen border-r border-slate-800">
      {/* Logo */}
