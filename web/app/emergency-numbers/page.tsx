          ...
          <div className="px-4 py-4 md:px-6 md:py-6">
            <div className="flex items-center justify-between">
              <div className="ml-10 md:ml-0">
                <h1 className="text-xl md:text-2xl font-bold text-black">Emergency Numbers</h1>
                    ...
                    <CardContent className="p-4 md:p-6">
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div className="flex items-center gap-4">
                          ...
                          >
                            <Phone size={24} color={getCategoryColor(item.category)} />
                          </div>
                          <div className="min-w-0">
                            <div className="flex flex-wrap items-center gap-2 mb-1">
                              <h3 className="text-base font-semibold text-black">{item.category}</h3>
                              {item.label && (
                            ...
                            <p className="text-lg font-mono font-bold text-black">{item.number}</p>
                          </div>
                        </div>
