...
export default function BarangayDashboardPage() {
  ...
  const { isAuthenticated, logout, adminName, adminRole, emailVerified } = useAuth();
          ...
          <div className="px-4 py-4 md:px-6 md:py-6">
            <div className="flex items-center justify-between">
              <div className="ml-10 md:ml-0">
                <h1 className="text-xl md:text-2xl font-bold text-slate-900">Welcome, {adminName || 'Barangay Official'}</h1>
            ...
            <div className="rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden">
              ...
              <div className="divide-y divide-slate-100">
                {announcements.length === 0 ? (
                  <div className="px-4 py-6 md:px-6 md:py-8 text-center text-sm text-slate-400">
